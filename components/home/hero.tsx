      ...
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              N-pass wipe engine with cryptographic verification. NIST-compliant, tamper-evident logs, and hardware-aware
              sanitization for SSDs, HDDs, servers, and mobiles—leaving zero chance of recovery.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Trusted by IT teams and security leaders</p>
