        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Wipe data. Prove it. Sleep well.</h2>
              <p className="text-white/60 md:mb-8">N-pass, NIST-compliant, audit-ready—built for zero recoverability.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
              ...
              <div className="flex items-center justify-center">
                <a href="#download">
                  <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] md:mt-10">
